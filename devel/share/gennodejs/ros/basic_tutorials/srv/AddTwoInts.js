...
// (in-package basic_tutorials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'basic_tutorials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'basic_tutorials/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'basic_tutorials/AddTwoInts'; }
};
